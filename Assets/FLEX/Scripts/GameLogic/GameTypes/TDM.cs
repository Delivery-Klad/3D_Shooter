...
*/
	...
	public void ShowSpawnMenu()
	{
		...
		InGameUI.instance.TDMSpawnMenu.SetActive (true);
	...
	void ScoreLimitCheck()
	{
        ...
        {
            GameManager.instance.GameManagerPhotonView.RPC("EndGame", PhotonTargets.AllBuffered, "Red team wins!");
		}
		if (PunTeams.Team.blue.GetTeamScore () == GameManager.instance.GameScoreLimit)
        {
			GameManager.instance.GameManagerPhotonView.RPC ("EndGame", PhotonTargets.AllBuffered, "Blue team wins!");
		}
	}
